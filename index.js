...
client.on('message', function (message) {
	//Commandes d'aides 
        ...
        .setThumbnail("https://cdn.discordapp.com/avatars/417351156369588226/12e0ea99d47b64863d07ca95e523258f.png?size=2048")
        .setColor('#6df5e6')
        .setTitle("Voici mes commandes d'aides !")
        ...
        .addField("**proba10|proba8|proba6|proba4|proba2**https://cdn.discordapp.com/avatars/417351156369588226/12e0ea99d47b64863d07ca95e523258f.png?size=2048", "Je pense que vous connaissez les règles du proba. Faites proba(le chiffre paire) direct à côté le proba et les votre chiffre 😜")
        ...
        .addField("**instagram 📸**", "``Cette commande vous affichera le lien qui vous mènera sur la chaîne YouTube officiel de ValC!``")
        .addField("**youtube 🎥**", "``Cette commande vous affichera le lien qui vous mènera sur le compte Instagram officiel de ValC!``")
     ...
     .setColor("RANDOM")
     .setImage("https://cdn.discordapp.com/avatars/417351156369588226/12e0ea99d47b64863d07ca95e523258f.png?size=2048")
    ...
    var mentionned = message.mentions.members.first();
      ...
      //Social
        ...
        message.channel.send(embed)
         ...
         let embed = new Discord.RichEmbed()
        .setTitle("Youtube🎙️                ")
        .addField("_Allez vous abonnez à ma chaîne 😉_", " la chaine YouTube de ValC : https://www.youtube.com/channel/UCeRygRLC3wD7GtO6ZKjxm-w")
        .setColor("RANDOM")
        .setAuthor(message.author.tag, message.author.displayAvatarURL)
        .setTimestamp()
        message.channel.send(embed)
        ...
        let embed = new Discord.RichEmbed()
        .setTitle("Instagram 📸                   ")
        .addField("_Venez suivre mon compte Instagram 😉_", " le compte Instagram de ValC : https://www.instagram.com/ValC6825/?hl=fr")
        .setColor("RANDOM")
        .setAuthor(message.author.tag, message.author.displayAvatarURL)
        .setTimestamp()
        message.channel.send(embed)
...
if (message.content.startsWith(prefix + "serveurlist")) {
       ...
       //Divers
          ...
          console.log("\x1b[2m")
           ...
           client.user.setActivity(` $help |ValC YT`);
});
